...
export const myProjects: MyProjectTypes[] = [
  {
    name: "Thaiup",
    detail:
      "ไทยอัป คือเว็บไซต์พอร์ทัลออนไลน์ที่รวบรวมและนำเสนอข้อมูลข่าวสารหลากหลายด้าน ทั้งข่าวทั่วไป ความรู้ ความบันเทิง กีฬา อสังหาริมทรัพย์ และเรื่องราวเกี่ยวกับความเชื่อ โดยมุ่งเน้นการอัปเดตเนื้อหาอย่างรวดเร็ว น่าสนใจ และครอบคลุมทุกความต้องการของผู้อ่าน",
    images: [{ src: "/images/projects/project-thaiup-01.jpg" }],
  ...
  },
  {
    ...
    name: "RadioLism",
    detail:
      "แอปพลิเคชันฟังวิทยุออนไลน์ฟรี! ทั่วโลก",
    images: [{ src: "/images/projects/project-radiolism-01.jpg" }],
    url: "https://radiolism.thaiup.net",
  },
];
